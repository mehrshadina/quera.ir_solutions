...
def create(product_type, product_id, product_name, product_price,):
...
def main():
    ...
    for _ in range(x):
        ...
        product = create(product_type, product_id, product_name, product_price)
        bb.add_product(product)

    bb.display_cart()
    discount_percentage = float(input())

    total_after_discount = bb.apply_off(discount_percentage)
